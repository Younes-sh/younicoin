...
import BtcCard from "./charts/BtcCard";
import EthCard from "./charts/EthCard";
import LtcCard from "./charts/LtcCard";
import DashCard from "./charts/DashCard";
import UsdtCard from "./charts/UsdtCard";
import XrpCard from "./charts/XrpCard";
import BtcHeader from "./charts/chartHeader";
import BuyButton from "./charts/Button";
...
class ChartContainer extends Component {
  ...
  render() {
    ...
    return (
      <section className="containerChart">
        <BtcHeader single={singlePrice[2]} />
        <BarGraph chartData={chartData} chartLabels={chartLabels} />
        <Container fluid className="text-center containerChart">
